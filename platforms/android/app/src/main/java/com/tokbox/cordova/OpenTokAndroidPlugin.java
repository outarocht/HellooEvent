...
public class OpenTokAndroidPlugin extends CordovaPlugin
    ...
    public OpenTokCustomVideoRenderer videoRenderer;
    ...
    public class RunnablePublisher extends RunnableUpdateViews implements
       ...
       */
        ...
        public RunnablePublisher(JSONArray args, OpenTokCustomVideoRenderer renderer) {
            this.mProperty = args;
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("initPublisher")) {
            this.videoRenderer = new OpenTokCustomVideoRenderer(cordova.getActivity().getApplicationContext());
            myPublisher = new RunnablePublisher(args, this.videoRenderer);
        ...
        } else if (action.equals("setIllustration")) {
            if(this.videoRenderer != null) {
                this.videoRenderer.updateIllustration(args);
            }
