...
The custom annotation renderer code can be found in the onFrame method (line 504) of the OpenTokCustomVideoRenderer.java file, as well as within the updateIllustration method (line 459) in the same file.